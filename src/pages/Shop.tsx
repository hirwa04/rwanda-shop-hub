      ...
      <div>
        ...
        <div className="space-y-1">
          ...
          {categories.map((cat) => (
            ...
            >
              {cat.name} <span className="text-xs opacity-60">({cat.productCount})</span>
            </button>
          ))}
        </div>
      </div>
        ...
        {filtersOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed right-0 top-0 bottom-0 w-72 bg-background z-50 shadow-2xl p-6 overflow-y-auto"
            >
