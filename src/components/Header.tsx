...
import { ShoppingCart, Search, Menu, X, Heart, User, Home, Grid3X3, ShoppingBag } from "lucide-react";
      ...
      <header className="sticky top-0 z-50 bg-background/95 backdrop-blur-md border-b border-border shadow-sm">
        <div className="container flex items-center justify-between h-14 sm:h-16">
          ...
          <div className="flex items-center gap-1 sm:gap-2">
            ...
            <Link
              to="/wishlist"
              className="hidden sm:flex p-2 rounded-full hover:bg-secondary transition-colors text-foreground"
            >
              <Heart className="w-5 h-5" />
            </Link>
            <Link
              to="/cart"
              className="p-2 rounded-full hover:bg-secondary transition-colors text-foreground relative"
            >
            ...
            >
              ...
              <nav className="p-4 flex flex-col gap-1">
                ...
                <Link
                  to="/account"
                  onClick={() => setMobileMenuOpen(false)}
                  className="px-4 py-3 rounded-lg text-sm font-medium hover:bg-secondary text-foreground"
                >
                  My Account
                </Link>
              </nav>
        ...
        <div className="flex items-center justify-around py-2">
          {[
            ...
            <Link
              key={item.to}
              to={item.to}
              className={`flex flex-col items-center gap-0.5 text-[10px] relative px-3 py-1 ${
